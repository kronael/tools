---
name: opus
description: /opus — launch a background subagent using the opus agent definition (fable at high effort). Use for complex reasoning, design decisions, and multi-file architecture work.
