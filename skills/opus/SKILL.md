---
name: opus
description: "/opus — implement changes, write code, execute multi-file fixes and features, and make design/architecture decisions (opus, xhigh). NOT for investigation/hunting (use /sonnet) or mechanical single-file work (use /haiku)."
