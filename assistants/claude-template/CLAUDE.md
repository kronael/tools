...
Claude Code configuration: 6 agents, 25 auto-activating skills, 5 commands.
...
**Skills** (25): agent-browser, cli, commit, create-eval, data, go,
merge-trivial, ops, pr-draft, py, recall, refine, release, rs,
service, sh, ship, specs, sql, sub, testing, trader, ts, tweet, wisdom
