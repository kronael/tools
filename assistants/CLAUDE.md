...
**Skills** (26): agent-browser, cli, commit, create-eval, data, go, merge-trivial, ops, pr-draft, py, recall, refine, release, rs, service, sh, ship, specs, sql, sub, testing, trader, ts, tsx, tweet, wisdom
