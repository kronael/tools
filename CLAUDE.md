...
**Working on the toolkit**: ALWAYS use ALWAYS/NEVER/SHOULD statements. Focus on non-obvious patterns LLMs fail to grasp. Test by re-installing and using in a real project.
