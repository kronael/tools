...
**Skills** (26): auto-activate based on file context (agent-browser,
cli, commit, create-eval, data, go, merge-trivial, ops, pr-draft,
py, recall, refine, release, rs, service, sh, ship, specs, sql, sub,
